...
<div class="rt-article <?php if ($this->item->state == 0) echo 'unpublished' ?>">
	<div class="rt-article-bg">
		...
		<div class="rt-headline"><?php if ($this->item->params->get('show_title')) : ?><h1 class="rt-article-title"><?php if ($this->item->params->get('link_titles') && $this->item->readmore_link != '') : ?><a href="<?php echo $this->item->readmore_link; ?>"><?php echo $this->escape($this->item->title); ?></a><?php else : ?><?php echo $this->escape($this->item->title); ?><?php endif; ?></h1><?php /** End Article Title **/ endif; ?>
		</div>
		<div class="clear"></div>
		<?php endif; ?>
