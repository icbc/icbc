...
if (!defined('SPLITMENU_TEMPLATE')) define('SPLITMENU_TEMPLATE','rt_iridium_j15');

//don't include class_sfx on 3rd level menu
$class_sfx = $menu->getParameter('startLevel')==2 ? '' : $menu->getParameter('class_sfx');
...
<ul class="menu<?php echo $class_sfx; ?> level1" <?php if($menu->getParameter('tag_id') != null):?>id="<?php echo $menu->getParameter('tag_id');?>"<?php endif;?>>
