 ...
 *
 * @version     $Id: view.html.php 2244 2011-06-25 10:31:18Z geraintedwards $
 * @package     JEvents
...
class AdminIcalrepeatViewIcalrepeat extends JEventsAbstractView
{
	...
	function edit($tpl = null)
	{
		...
		// WHY THE HELL DO THEY BREAK PUBLIC FUNCTIONS !!!
		if (JVersion::isCompatible("1.6.0")) JEVHelper::stylesheet( 'eventsadmin.css', 'administrator/components/'.JEV_COM_COMPONENT.'/assets/css/');
