...
class SimuleFrontViewOscip extends JView{
	function display($tpl = null) {
		...
		$pessoa = JHTML::_("select.radiolist", $listaPessoa, "tipoPessoa", "onclick='verificaValor(); validaTipoPessoa();'", "value", "text", $registro->pessoa);
