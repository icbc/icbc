<?php
/**
 * @version 1.0 $Id: eventlist.php 990 2009-03-20 11:25:23Z julienv $
 * @package Joomla
...
class EventListModelMy extends JModel
{
    ...
    function __construct()
    {
        ...
        $limit 					= $mainframe->getUserStateFromRequest('com_eventlist.my.limit', 'limit', $params->def('display_num', 0), 'int');
